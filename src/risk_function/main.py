...
# Crash_Frequency.timeOfDay(5, 2024, 5, 2025)
...
Stat_Calculation.getSeverityHistogram('rainy_weather_incidents.csv','Highest Injury Severity Alleged')
Crash_Frequency.filterRain()